...
class ContactSearch extends Contact
{
    ...
    {
        return [
            [['id', 'party_id', 'party_type_id', 'contact_type_id', 'contact_txt', 'is_primary', 'status', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
            [['name'], 'safe'],
        ];
    }
